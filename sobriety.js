(() => {
  ...
  // NICOTINE REPLACEMENT / QUIT TOOLS SECTION
  if(!document.querySelector('#nicotine-quit-tools')){
    const qcss=document.createElement('style');
    qcss.textContent=`
      .quit-tools{padding:11vh 6vw;background:linear-gradient(180deg,#071014,#0d1d23 55%,#08090a);border-top:1px solid #ffffff18;border-bottom:1px solid #ffffff18}
      .quit-tools h2{font-size:clamp(52px,9vw,126px);line-height:.84;letter-spacing:-.06em;margin:0 0 26px}.quit-tools .intro{max-width:850px;color:#c8d1d5;font-size:clamp(17px,1.6vw,21px);line-height:1.75;margin-bottom:36px}
      .quit-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(235px,1fr));gap:12px}.quit-card{border:1px solid #ffffff1d;background:#0a1115;padding:24px;min-height:210px}.quit-card small{display:block;color:#78d9e9;font-size:10px;letter-spacing:.15em;font-weight:1000;margin-bottom:10px}.quit-card b{display:block;font-size:22px;margin-bottom:10px}.quit-card p{margin:0;color:#aab5ba;line-height:1.6}.quit-visual{height:92px;margin-bottom:16px;position:relative}.patch-icon{width:74px;height:74px;border-radius:14px;background:linear-gradient(145deg,#f4e9d9,#d8c6ae);box-shadow:inset 0 0 0 4px #fff8,0 12px 26px #0005;transform:rotate(-8deg)}.gum-icon{display:flex;gap:7px;align-items:center;height:100%}.gum-icon span{width:44px;height:25px;border-radius:8px;background:#e8ecef;box-shadow:inset 0 -4px 0 #ccd4d8}.lozenge-icon{width:64px;height:64px;border-radius:50%;background:radial-gradient(circle at 30% 25%,#fff,#d8e4e7);box-shadow:0 10px 24px #0005}.inhaler-icon{width:44px;height:84px;border-radius:12px;background:#e8eef0;position:relative}.inhaler-icon:after{content:'';position:absolute;left:8px;right:8px;top:12px;height:34px;border-radius:8px;background:#8dd2df}.spray-icon{width:48px;height:76px;border-radius:10px;background:#e8eef0;position:relative}.spray-icon:before{content:'';position:absolute;width:42px;height:16px;left:2px;top:-10px;border-radius:8px;background:#8bd3df}.combo-icon{display:flex;gap:14px;align-items:center}.combo-icon .patch-icon{width:58px;height:58px}.quit-note{max-width:900px;margin-top:30px;padding:20px;border-left:3px solid #78d9e9;background:#0a1215;color:#aeb9bd;line-height:1.65}.quit-note b{color:#fff}
    `;
    document.head.appendChild(qcss);
    const sec=document.createElement('section');sec.id='nicotine-quit-tools';sec.className='quit-tools';
    sec.innerHTML=`<div class="eyebrow" style="color:#78d9e9">NICOTINE REPLACEMENT & QUIT TOOLS</div><h2>TOOLS TO HELP<br>BREAK THE LOOP.</h2><p class="intro">Nicotine replacement therapy, often called NRT, gives the body nicotine without smoke or vape aerosol. The goal is to reduce withdrawal and cravings while someone works on changing the habit itself. These products are different from cigarettes, disposable vapes and recreational nicotine pouches because they are designed as quit aids.</p><div class="quit-grid"><div class="quit-card"><div class="quit-visual"><div class="patch-icon"></div></div><small>STEADY SUPPORT</small><b>Nicotine Patch</b><p>Worn on the skin and releases nicotine slowly over many hours. It is often used for background cravings throughout the day.</p></div><div class="quit-card"><div class="quit-visual gum-icon"><span></span><span></span><span></span></div><small>FAST CRAVING HELP</small><b>Nicotine Gum</b><p>Provides nicotine through the lining of the mouth. It can be useful when a craving hits instead of needing constant nicotine delivery.</p></div><div class="quit-card"><div class="quit-visual"><div class="lozenge-icon"></div></div><small>DISSOLVES SLOWLY</small><b>Nicotine Lozenge</b><p>Dissolves in the mouth and can help with sudden cravings. It works similarly to gum but does not require chewing.</p></div><div class="quit-card"><div class="quit-visual"><div class="inhaler-icon"></div></div><small>PRESCRIPTION OPTION</small><b>Nicotine Inhaler</b><p>A prescription quit aid in the U.S. that delivers nicotine through the mouth. It can also replace some of the hand-to-mouth routine of smoking.</p></div><div class="quit-card"><div class="quit-visual"><div class="spray-icon"></div></div><small>PRESCRIPTION OPTION</small><b>Nicotine Nasal Spray</b><p>A fast-acting prescription form of nicotine replacement that can help with strong cravings.</p></div><div class="quit-card"><div class="quit-visual combo-icon"><div class="patch-icon"></div><div class="lozenge-icon"></div></div><small>COMBINATION NRT</small><b>Patch + Gum/Lozenge</b><p>Some adults use a patch for steady support plus gum or a lozenge for breakthrough cravings. A clinician or pharmacist can help choose the right approach.</p></div></div><div class="quit-note"><b>Important:</b> nicotine replacement still contains nicotine, so it should be used as directed. For teens, pregnancy, heart conditions, medication questions or uncertainty about which product is appropriate, talk with a clinician or pharmacist. Quit support and counseling can improve the chances of staying nicotine-free.</div>`;
    const help=document.querySelector('#help');
    if(help&&help.parentNode) help.parentNode.insertBefore(sec,help); else document.body.appendChild(sec);
  }
